...
// Agent// AgentForge Model 域 IPC Handlers
// 实现 P1-06: 模型配置 CRUD + 连接测试
// 通道命名: domain:action 格式 (model:list, model:create, ...)

import { ipcMain, type IpcMainInvokeHandler } from 'electron'
import OpenAI from 'openai'
import type { ModelConfig, ModelProvider } from '@shared/types// AgentForge Model 域 IPC Handlers
// 实现 P1-06: 模型配置 CRUD + 连接测试
// 通道命名: domain:action 格式 (model:list, model:create, ...)
...
import {
  ...
  type CreateModelParams,
  type UpdateModelParams,
} from '../db// AgentForge Model 域 IPC Handlers
// 实现 P1-06: 模型配置 CRUD + 连接测试
// 通道命名: domain:action 格式 (model:list, model:create, ...)
...
import { invalidateModelCache }// AgentForge Model 域 IPC Handlers
// 实现 P1-06: 模型配置 CRUD + 连接测试
// 通道命名: domain:action 格式 (model:list, model:create, ...)
 ...
 * @param modelId - 变更的模型 ID
 */
function invalidateModel// AgentForge Model 域 IPC Handlers
// 实现 P1-06: 模型配置 CRUD + 连接测试
// 通道命名: domain:action 格式 (model:list, model:create, ...)
...
const VALID_PROVIDERS:// AgentForge Model 域 IPC Handlers
// 实现 P1-06: 模型配置 CRUD + 连接测试
// 通道命名: domain:action 格式 (model:list, model:create, ...)
...
const VALID_PROVIDERS: readonly ModelProvider[] = ['openai', '// AgentForge Model 域 IPC Handlers
// 实现 P1-06: 模型配置 CRUD + 连接测试
// 通道命名: domain:action 格式 (model:list, model:create, ...)
 ...
 * 返回的 apiKey 字段为 '***'
 */
function handleCreate// AgentForge Model 域 IPC Handlers
// 实现 P1-06: 模型配置 CRUD + 连接测试
// 通道命名: domain:action 格式 (model:list, model:create, ...)
...
function handleCreate(params: unknown): ModelConfig {
  ...
  const name = validateNonEmptyString(p['name'], 'name')
  const provider = validate// AgentForge Model 域 IPC Handlers
// 实现 P1-06: 模型配置 CRUD + 连接测试
// 通道命名: domain:action 格式 (model:list, model:create, ...)
...
function handleUpdate(params: unknown): void {
  ...
  const id = validateNonEmptyString(p['id'], '// AgentForge Model 域 IPC Handlers
// 实现 P1-06: 模型配置 CRUD + 连接测试
// 通道命名: domain:action 格式 (model:list, model:create, ...)
...
function handleUpdate(params: unknown): void {
  ...
  const apiKey = validateOptionalString(p['apiKey'], 'apiKey')
  const baseUrl = validateOptionalString(p['baseUrl'], 'baseUrl')
  const temperature = validateOptional// AgentForge Model 域 IPC Handlers
// 实现 P1-06: 模型配置 CRUD + 连接测试
// 通道命名: domain:action 格式 (model:list, model:create, ...)
...
/**
 * model:// AgentForge Model 域 IPC Handlers
// 实现 P1-06: 模型配置 CRUD + 连接测试
// 通道命名: domain:action 格式 (model:list, model:create, ...)
 ...
 * model:delete - 删除模型配置
 * 删除默认模型时抛出 MODEL_DELETE_DEFAULT
 * 清除 ModelRouter 缓存（目前仅// AgentForge Model 域 IPC Handlers
// 实现 P1-06: 模型配置 CRUD + 连接测试
// 通道命名: domain:action 格式 (model:list, model:create, ...)
 ...
 * 清除 ModelRouter 缓存（目前仅日志）
 */
function handleDelete(params: unknown):// AgentForge Model 域 IPC Handlers
// 实现 P1-06: 模型配置 CRUD + 连接测试
// 通道命名: domain:action 格式 (model:list, model:create, ...)
 ...
 * model:get - 查询单个模型配置（apiKey 掩码为 '***'）
 */
function handleGet// AgentForge Model 域 IPC Handlers
// 实现 P1-06: 模型配置 CRUD + 连接测试
// 通道命名: domain:action 格式 (model:list, model:create, ...)
...
function handleGet(params: unknown): ModelConfig {
  ...
  const id = validateNonEmptyString(p['// AgentForge Model 域 IPC Handlers
// 实现 P1-06: 模型配置 CRUD + 连接测试
// 通道命名: domain:action 格式 (model:list, model:create, ...)
...
/**
 * model:test - 测试模型连接
 * 向 API 发送 "// AgentForge Model 域 IPC Handlers
// 实现 P1-06: 模型配置 CRUD + 连接测试
// 通道命名: domain:action 格式 (model:list, model:create, ...)
...
/**
 * model:test - 测试模型连接
 * 向 API 发送 "Hi" 消息，返回 { success,// AgentForge Model 域 IPC Handlers
// 实现 P1-06: 模型配置 CRUD + 连接测试
// 通道命名: domain:action 格式 (model:list, model:create, ...)
...
async function handleTest(
  ...
  const p = ensureParams// AgentForge Model 域 IPC Handlers
// 实现 P1-06: 模型配置 CRUD + 连接测试
// 通道命名: domain:action 格式 (model:list, model:create, ...)
...
async function handleTest(
  ...
  // 获取解密后的模型// AgentForge Model 域 IPC Handlers
// 实现 P1-06: 模型配置 CRUD + 连接测试
// 通道命名: domain:action 格式 (model:list, model:create, ...)
...
async function handleTest(
  ...
  const clientOptions: ConstructorParameters<typeof OpenAI>[0] = {
    apiKey: config// AgentForge Model 域 IPC Handlers
// 实现 P1-06: 模型配置 CRUD + 连接测试
// 通道命名: domain:action 格式 (model:list, model:create, ...)
...
async function handleTest(
  ...
  try {
    ...
    const latency = Date.now() - startTime
    return { success: true// AgentForge Model 域 IPC Handlers
// 实现 P1-06: 模型配置 CRUD + 连接测试
// 通道命名: domain:action 格式 (model:list, model:create, ...)
...
async function handleTest(
  ...
  try {
    ...
    const latency = Date.now() - startTime
    const errorMessage = error instanceof Error ? error.message// AgentForge Model 域 IPC Handlers
// 实现 P1-06: 模型配置 CRUD + 连接测试
// 通道命名: domain:action 格式 (model:list, model:create, ...)
...
async function handleTest(
  ...
  try {
    ...
    const latency = Date.now() - startTime
    const errorMessage = error instanceof Error ? error.message : String(error)
    return { success: false// AgentForge Model 域 IPC Handlers
// 实现 P1-06: 模型配置 CRUD + 连接测试
// 通道命名: domain:action 格式 (model:list, model:create, ...)
...
const registrations: ChannelRegistration[] = [
  { channel: 'model:list', handler: () => handleList() },
  { channel: 'model:create', handler: (_event, params: unknown) => handleCreate(params) },
  { channel: 'model:update', handler: (_event, params: unknown// AgentForge Model 域 IPC Handlers
// 实现 P1-06: 模型配置 CRUD + 连接测试
// 通道命名: domain:action 格式 (model:list, model:create, ...)
...
const registrations: ChannelRegistration[] = [
  ...
  { channel: 'model:create', handler: (_event, params: unknown) => handleCreate(params) },
  { channel: 'model:update', handler: (_event, params: unknown) => handleUpdate(params) },
  { channel: 'model:delete', handler: (_event// AgentForge Model 域 IPC Handlers
// 实现 P1-06: 模型配置 CRUD + 连接测试
// 通道命名: domain:action 格式 (model:list, model:create, ...)
